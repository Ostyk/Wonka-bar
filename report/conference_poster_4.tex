...
\headerbox{Dataset}{name=results,column=0,span=2,row=0}{
...
\headerbox{Methodology}{name=objectives,column=2,row=0}{
...
\headerbox{Introduction}{name=introduction,column=3,row=0,bottomaligned=objectives}{
...
\headerbox{Conclusion}{name=conclusion,column=0,span=2,row=0,below=results,above=references}{
...
\headerbox{Training Pipeline}{name=method,column=2, span = 2, below=objectives,bottomaligned=conclusion}{ % This block's bottom aligns with the bottom of the conclusion block
...
%\headerbox{Results 2}{name=results2,column=3,below=objectives,bottomaligned=conclusion}{ % This block's bottom aligns with the bottom of the conclusion block
%
